...
public class GameOverState : AState
{
    ...
    // Create instance for repositioning of enmy
    public bool IsRunAgain = false;
    ...
    {
        EnemyCharacter.instance.enabled = true;
    ...
    {
        EnemyCharacter.instance.enabled = true;
        GameState.instance.Splashblur.SetActive(true);
        HelperUtil.CallAfterDelay(() =>
        {
            Debug.Log("loading hide");
            GameState.instance.Splashblur.SetActive(false);
        }, 4.5f);
        IsRunAgain = true;
        trackManager.isRerun = false;
